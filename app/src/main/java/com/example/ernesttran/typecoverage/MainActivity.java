...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor resultSet = allData.rawQuery("SELECT ID, Species FROM Pokemon",null);
        int length = resultSet.getColumnCount();

        //Start on first Row
        if (resultSet.moveToFirst()) {
            for (int i = 0; i < length; i++) {
                //Get Information from Cursor
                Integer currID = resultSet.getInt(0);
                String currName = resultSet.getString(1);
        ...
        //Build Array Adapter
        SpeciesNames = new String[PokemonList.size()];
        PokemonList.keySet().toArray(SpeciesNames);
        ArrayAdapter<String> nameAdapater = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, SpeciesNames);
        //</editor-fold>
        ...
        pokemon1_EditText.setAdapter(nameAdapater);
        ///Move Group
        ...
        pokemon2_EditText.setAdapter(nameAdapater);
        ///Move Group
        ...
        pokemon3_EditText.setAdapter(nameAdapater);
        ///Move Group
        ...
        pokemon4_EditText.setAdapter(nameAdapater);
        ///Move Group
        ...
        pokemon5_EditText.setAdapter(nameAdapater);
        ///Move Group
        ...
        pokemon6_EditText.setAdapter(nameAdapater);
        ///Move Group
